...
<span id=quote>
      ...
      “<i>Ang Madrasah system dito…karamihan ang mga tinuturo ay lenggwahe ng Arabo. Mag-aaral [ang mga bata] ng Arabic language tapos aside from that yung basic knowledge sa Islam…Hindi siya in-depth, kung hindi napaka-basic lang yung tinuturo [sa kanila].</i>” <br><br>

      (<i>Madrasah</i> schools often focus on teaching students Arabic language and basic knowledge of Islam. These are not in-depth because they only provide basic understanding.) <br><br>
...
export default {
  ...
  metaInfo: {
    ...
    meta: [
        ...
        {name: 'description', content: 'Title: Beyond makeshift classrooms, Authors: Thea Soriano, Danielle Garcia, place: Marawi, organization: The GUIDON'}
